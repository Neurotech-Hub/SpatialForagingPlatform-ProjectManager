...
Lightweight record of cross-lab meetings. The intent is to capture decisions
and action items so the rest of the team can stay aligned without attending
every call. Full transcripts are not required.
